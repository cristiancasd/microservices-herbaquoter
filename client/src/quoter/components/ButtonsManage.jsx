...
import {
  startDeleteQuoter,
  startUploadingImageQuoter,
  startUploadingFiles,
  startDeleteProduct,
} from '../../store/quoter/thunks';
...
export const ButtonsManage = ({
  ...
  console.log(
    'activeQuoter.isDefaultQuoter, navBarSelectio, quoterProcess',
    activeQuoter.isDefaultQuoter,
    navBarSelection,
    quoterProcess
  );
  ...
  return (
    <Box sx={{ flexGrow: 1 }}>
      ...
      >
        <Grid item>
          <Typography fontSize={34} fontWeight="light">
            {' '}
            {quoterProcess} {navBarSelection}
          </Typography>
          ...
          <Button
            ...
            style={
              navBarSelection === 'quoters'
                ? quoterProcess === 'View' && !activeQuoter.isDefaultQuoter
                  ? { display: '' }
                  : { display: 'none' }
                : quoterProcess === 'View' && user.rol !== 'user'
                ? { display: '' }
                : { display: 'none' }
            }
          >
